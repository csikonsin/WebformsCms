...
var _moduleEditadd = __webpack_require__(37);

var _moduleEditadd2 = _interopRequireDefault(_moduleEditadd);

var _cmsEditor = __webpack_require__(56);

var _cmsEditor2 = _interopRequireDefault(_cmsEditor);

var _menuAdd = __webpack_require__(59);
...
var _adminEditToggle = __webpack_require__(60);
...
*/
var aa=__webpack_require__(2),l=__webpack_require__(12),B=__webpack_require__(5),C=__webpack_require__(3),ba=__webpack_require__(13),da=__webpack_require__(14),ea=__webpack_require__(15),fa=__webpack_require__(16),ia=__webpack_require__(17),D=__webpack_require__(6);
...
var ModuleEditAdd = function (_React$Component) {
    _inherits(ModuleEditAdd, _React$Component);

    function ModuleEditAdd(props) {
        _classCallCheck(this, ModuleEditAdd);

        var _this = _possibleConstructorReturn(this, (ModuleEditAdd.__proto__ || Object.getPrototypeOf(ModuleEditAdd)).call(this, props));

        var instance = _this;
        _eventEmitter2.default.subscribe("add-module", function (_ref) {
        ...
        _eventEmitter2.default.subscribe("delete-module", function (_ref2) {
    ...
    _createClass(ModuleEditAdd, [{
        ...
        value: function render() {
            ...
            if (this.props.moduleId == 0) {
                type = _react2.default.createElement(
                    "a",
                    { className: "button add-modoule", onClick: this.handleOpen.bind(this) },
                    "Neues Modul hinzuf\xFCgen"
                );
            } else {
                type = _react2.default.createElement(
                    "div",
                    { className: "editdel-module" },
                    _react2.default.createElement(
                        "div",
                        { className: "wrapper" },
                        _react2.default.createElement(
                            "a",
                            { className: "button edit-modoule", onClick: this.handleEdit.bind(this) },
                            "Bearbeiten"
                        ),
                        _react2.default.createElement(
                            "a",
                            { className: "button del-module", onClick: this.handleDelete.bind(this) },
                            "L\xF6schen"
                        )
                    )
                );
            ...
            var display = _react2.default.createElement(
                "div",
                { className: "wrapper", ref: function ref(wrapper) {
        ...
        key: "handleOpen",
        value: function handleOpen(_ref3) {
            var isDelete = _ref3.isDelete,
                isEdit = _ref3.isEdit;

            _eventEmitter2.default.dispatch("open-add-module", {
                caller: this,
        ...
        key: "deleteModule",
        value: function deleteModule(menuId, moduleId) {
            var _this3 = this;

            _axios2.default.post("/Api/Modules.asmx/DeleteModule", {
                menuId: this.props.menuId,
                moduleId: this.props.moduleId
            }).then(function (r) {
                _this3.wrapper.parentElement.previousSibling.remove();
                _this3.setState({ deleted: true });
                _eventEmitter2.default.dispatch("close-editor", null);
            }).catch(function (e) {
                console.error(e);
            });
        }
...
var _menuEditor = __webpack_require__(57);

var _menuEditor2 = _interopRequireDefault(_menuEditor);

var _moduleEditor = __webpack_require__(58);

var _moduleEditor2 = _interopRequireDefault(_moduleEditor);
...
var CmsEditor = function (_React$Component) {
    _inherits(CmsEditor, _React$Component);

    function CmsEditor(props) {
        _classCallCheck(this, CmsEditor);

        var _this = _possibleConstructorReturn(this, (CmsEditor.__proto__ || Object.getPrototypeOf(CmsEditor)).call(this, props));

        var instance = _this;

        _eventEmitter2.default.subscribe("open-add-menu", function (_ref) {
            var caller = _ref.caller,
                parentControlId = _ref.parentControlId,
                parentMenuId = _ref.parentMenuId;

            instance.openEditor();
            instance.setState({
                open: true,
                caller: caller,
                tab: _react2.default.createElement(_menuEditor2.default, { parentControlId: parentControlId, parentMenuId: parentMenuId })
            });
        });

        _eventEmitter2.default.subscribe("open-add-module", function (_ref2) {
            var caller = _ref2.caller,
                menuId = _ref2.menuId,
                moduleId = _ref2.moduleId,
                isEdit = _ref2.isEdit,
            ...
            instance.setState({
                open: true,
                tab: _react2.default.createElement(_moduleEditor2.default, { caller: caller, menuId: menuId, moduleId: moduleId, isEdit: isEdit, isDelete: isDelete, parent: instance, closeEditor: instance.closeEditor })
            });
        });

        _eventEmitter2.default.subscribe("close-editor", function () {
    ...
    _createClass(CmsEditor, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                { id: "cms-editor", className: this.state.open ? 'open' : '', ref: function ref(editor) {
                        return _this2.editor = editor;
                    } },
                this.state.tab,
                _react2.default.createElement("a", { className: "button close", href: "javascript:void(0)", onClick: this.closeEditor.bind(this) })
            );
        }
    }, {
        key: "openEditor",
        ...
        key: "openNewModule",
        value: function openNewModule() {
            this.search.focus();
        }
    }, {
        key: "openNewMenu",
        value: function openNewMenu() {}
    }]);

    return CmsEditor;
}(_react2.default.Component);

exports.default = CmsEditor;
...
var MenuEditor = function (_React$Component) {
    _inherits(MenuEditor, _React$Component);
    ...
    _createClass(MenuEditor, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                { className: "menu-editor", ref: function ref(wrapper) {
                        return _this2.wrapper = wrapper;
                    } },
                _react2.default.createElement(
                    "h1",
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement("input", { value: this.state.name, onChange: this.handleNameChange.bind(this), type: "text" })
                    ),
                    _react2.default.createElement(
                        "div",
                        { className: "row" },
                        ...
                        _react2.default.createElement("input", { value: this.state.relativeUrl, onChange: this.handleRelativeUrlChange.bind(this), type: "text" })
                    ),
                    _react2.default.createElement(
                        "div",
                        { className: "row" },
                        ...
                        _react2.default.createElement("input", { type: "checkbox", name: "start", onChange: this.handleHomepageChange.bind(this) })
                    ),
                    _react2.default.createElement(
                        "div",
                        { className: "row" },
                        _react2.default.createElement(
                            "button",
                            { onClick: this.handleAddMenu.bind(this) },
                            "Hinzuf\xFCgen"
                        )
                    )
                )
        ...
        key: "handleHomepageChange",
        value: function handleHomepageChange(e) {
            this.setState({
        ...
        key: "handleRelativeUrlChange",
        value: function handleRelativeUrlChange(e) {
            this.setState({
        ...
        key: "handleAddMenu",
        value: function handleAddMenu() {
            _axios2.default.post("/api/Menus.asmx/MenuAddEdit", {
...
var ModuleButton = function (_React$Component) {
    _inherits(ModuleButton, _React$Component);

    function ModuleButton(props) {
        _classCallCheck(this, ModuleButton);

        return _possibleConstructorReturn(this, (ModuleButton.__proto__ || Object.getPrototypeOf(ModuleButton)).call(this, props));
    }
    ...
    _createClass(ModuleButton, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                { className: "module-button", onClick: this.handleAddModule.bind(this) },
                _react2.default.createElement(
                    "label",
                    null,
                    this.props.name
                ),
                _react2.default.createElement("div", { className: "button-inner" })
            );
        }
    }, {
        key: "handleAddModule",
        value: function handleAddModule() {
            _eventEmitter2.default.dispatch("add-module", {
...
var ModuleEditor = function (_React$Component2) {
    _inherits(ModuleEditor, _React$Component2);

    function ModuleEditor(props) {
        _classCallCheck(this, ModuleEditor);

        var _this2 = _possibleConstructorReturn(this, (ModuleEditor.__proto__ || Object.getPrototypeOf(ModuleEditor)).call(this, props));
    ...
    _createClass(ModuleEditor, [{
        ...
        key: "handleDeleteModule",
        value: function handleDeleteModule(e) {
            _eventEmitter2.default.dispatch("delete-module", {
                caller: this.props.caller,
                menuId: this.props.menuId,
                moduleId: this.props.moduleId
            });
        ...
        value: function handleClose(e) {
            var close = this.props.closeEditor.bind(this.props.parent);
            close();
            e.preventDefault();
        }
    }, {
        ...
        value: function render() {
            ...
            if (this.props.isEdit) {} else if (this.props.isDelete) {
...
var MenuAdd = function (_React$Component) {
    _inherits(MenuAdd, _React$Component);

    function MenuAdd(props) {
        _classCallCheck(this, MenuAdd);

        var _this = _possibleConstructorReturn(this, (MenuAdd.__proto__ || Object.getPrototypeOf(MenuAdd)).call(this, props));

        _this.state = {};
        return _this;
    }

    _createClass(MenuAdd, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "div",
                ...
                _react2.default.createElement(
                    "div",
                    { className: "button add-menu", onClick: this.addMenu.bind(this) },
                    "Neuen Men\xFCpunkt hinzuf\xFCgen"
                )
            );
        }
    }, {
        ...
        value: function addMenu() {
            _eventEmitter2.default.dispatch("open-add-menu", {
                caller: this,
                parentControlId: this.props.parentControlId,
